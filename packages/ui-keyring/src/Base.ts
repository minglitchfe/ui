...
export class Base {
  ...
  protected async initKeyring (options: KeyringOptions): Promise<void> {
  ...
  protected async addAccountPairs (): Promise<void> {
    this.keyring
      .getPairs()
      .forEach(async ({ address, meta }: KeyringPair): Promise<void> => {
